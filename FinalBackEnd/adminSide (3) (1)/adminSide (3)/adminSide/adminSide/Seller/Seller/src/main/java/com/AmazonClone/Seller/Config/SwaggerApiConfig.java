package com.AmazonClone.Seller.Config;
...
public class SwaggerApiConfig {
    public static final String SWAGGER_INFO_TITLE = "AmazonClone API";
    public static final String SWAGGER_INFO_DESCRIPTION = "This is AmazonClone API documentation";
    public static final String SWAGGER_INFO_VERSION = "1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME = "Iamneo";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "richa.gupta@iamneo.ai";
